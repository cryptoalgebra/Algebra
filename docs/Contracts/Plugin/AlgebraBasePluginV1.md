...
Algebra Integral 1.2.2 adaptive fee plugin



**Inherits:** [DynamicFeePlugin](plugins/DynamicFeePlugin.md) [FarmingProxyPlugin](plugins/FarmingProxyPlugin.md) [VolatilityOraclePlugin](plugins/VolatilityOraclePlugin.md)
...
```solidity
constructor(address _pool, address _factory, address _pluginFactory, struct AlgebraFeeConfiguration _config) public
```
