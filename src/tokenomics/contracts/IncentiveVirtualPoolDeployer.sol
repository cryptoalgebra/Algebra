...
import './virtualPools/IncentiveVirtualPool.sol';

contract IncentiveVirtualPoolDeployer is IVirtualPoolDeployer {
    ...
    function deploy(
        ...
        virtualPool = address(
            new IncentiveVirtualPool(poolAddress, _farming, _desiredStartTimestamp, _desiredEndTimestamp)
        );
    }
}
