...
import './plugins/ILimitOrderPlugin.sol';
...
interface IAlgebraBasePluginV1 is IVolatilityOracle, IDynamicFeeManager, IFarmingPlugin, ILimitOrderPlugin, IAlgebraMintCallback {
