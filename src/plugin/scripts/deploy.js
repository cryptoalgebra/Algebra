...
async function main() {
    ...
    const dsFactory = await BasePluginV1Factory.deploy(deploysData.factory, {gasLimit:"8000000"});
    ...
    await factory.setDefaultPluginFactory(dsFactory.target,{gasLimit:"8000000"})
