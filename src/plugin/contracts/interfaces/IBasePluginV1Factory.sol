...
interface IBasePluginV1Factory is IAlgebraPluginFactory {
  ...
  /// @notice Emitted when the withdrawal fee plugin address is changed
  /// @param newWithdrawalFeePlugin The withdrawal address after the address was changed
  event WithdrawalFeePlugin(address newWithdrawalFeePlugin);
  ...
  /// @dev updates withdrawal fee plugin address on the plugin factory
  /// @param newWithdrawalFeePlugin The new withfrawal fee plugin address
