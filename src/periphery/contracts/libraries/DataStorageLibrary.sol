...
import '@cryptoalgebra/plugins/contracts/interfaces/IAlgebraBasePluginV1.sol';
...
library DataStorageLibrary {
    ...
    function consult(address pool, uint32 period) internal view returns (int24 timeWeightedAverageTick) {
        ...
        IAlgebraBasePluginV1 dsOperator = IAlgebraBasePluginV1(IAlgebraPool(pool).plugin());
