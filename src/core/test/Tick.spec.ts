...
describe('Tick', () => {
  ...
  describe('#update', async () => {
    ...
    it('reverts if total liquidity gross is greater than max', async () => {
      await tickTest.update(0, 0, BigNumber.from('40564824043007195767232224305152').div(2), 0, 0, 0, 0, 0, false,)
      await tickTest.update(0, 0, BigNumber.from('40564824043007195767232224305152').div(2), 0, 0, 0, 0, 0, true,)
      await expect(tickTest.update(0, 0, BigNumber.from('40564824043007195767232224305152').div(2), 0, 0, 0, 0, 0, false,)).to.be.revertedWith('LO')
    })
    ...
    it('reverts on overflow liquidity gross', async () => {
      await tickTest.update(0, 0, BigNumber.from('40564824043007195767232224305152').div(2).sub(1), 0, 0, 0, 0, 0, false)
