...
interface IAlgebraPoolDeployer {
  ...
  /// @return algebraPoolExtension The pool extension contract address for flash loans
  function getDeployParameters()
    external
    view
    returns (address plugin, address factory, address token0, address token1, address algebraPoolExtension);
