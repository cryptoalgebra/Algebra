...
async function main() {
  ...
  const partnerAddress = "0x05A9484542f8671cBf379F14Ff85a9Ee1438c74b" // owner address, must be changed
  const algebraFeeShare =  15 // specified on algebraVault, 100% of community fee by default(3% of all fees) 
